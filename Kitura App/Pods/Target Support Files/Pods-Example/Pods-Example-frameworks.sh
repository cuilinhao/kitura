...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/HeliumLogger/HeliumLogger.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/KituraNIOLinuxHelpers/CLinuxHelpers.framework"
